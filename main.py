...
#Label为标签控件
    ...
    def get_result_count(self):
        try:
            ...
            if fei < 2460:
                ...
                gfei = 50
            elif fei >= 3100 and fei < 3220:
                gfei = 60
            elif fei >= 3220 and fei < 3340:
                gfei = 62
    ...
    def write_to_Text(self, result):
        self.result_data_Text.delete(1.0, 10.0)#删除【1，10）的元素
        self.result_data_Text.insert(END, result)


def gui_start():
    init_window = Tk()
    ZMJ_PORTAL = MY_GUI(init_window)#使用这个类
    ZMJ_PORTAL.set_init_window()
    init_window.mainloop()#事件的循环
